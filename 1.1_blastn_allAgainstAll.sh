...
blastn -query $FILE -db $DB -task blastn -evalue 10e-6 -num_threads 8 -outfmt "6 qseqid sseqid evalue pident bitscore qstart qend qlen sstart send slen" -out $OUTPUT    # For nucleotide sequences
